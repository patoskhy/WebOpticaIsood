...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-08-2018 a las 16:30:10
...
('OPERAT', 'O00001', 'PUBLICO'),
('OPERAT', 'O00002', 'PRIVADO'),
...
CREATE TABLE `brc_operativos` (
  ...
  `TIPO_OPERATIVO` varchar(6) NOT NULL,
...
('6000000000', '61000000001', 'COPIA DE RECETA', 0, 'S', '962875769714', '0');
...
('1', '9', 'ADMINISTRADOR', 'ADMINISTRADOR', '4DM1N1.', 'default-avatar.jpg', 'S');
...
ALTER TABLE `brc_producto_web`
  ADD PRIMARY KEY (`CODIGO`,`VIGENCIA`,`COD_TIPO`,`COD_MARCA`,`MODELO`,`COD_MATERIAL`,`COD_COLOR`,`COD_FORMA`);
