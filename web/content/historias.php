<?php
    ...
    $SELECT = "SELECT ID,TITULO,FOTO,VIGENCIA FROM brc_historias_web WHERE VIGENCIA = 'S' ";
            ...
            <div class="col-md-4 d-flex align-self-stretch ftco-animate ">
                <div class="media block-6 services d-block text-center">
                    <div class="d-flex justify-content-center">
                        <img src="comun/muestraImagenHistoria.php?cod=<?=$data[$i]["ID"]?>" class="img-responsive img-thumbnail"/>
                    </div>
    ...
    <?php } else { ?> 
        <div class="col-md-10">
            <div class="panel panel-default text-center">
                <div class="panel-heading">Historias</div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">No existen historias registrados en este momento.</div>
                        </div> 
                    </div>
                </div>
            </div>
