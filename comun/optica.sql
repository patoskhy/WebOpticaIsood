...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-05-2018 a las 03:12:57
...
(0, 100000000, 'INICIO', 'home', '/SistemaOptica/web/index.php'),
(0, 200000000, 'LOGOUT', 'sign-out', '/SistemaOptica/web/index.php?r=site/logout'),
...
(310000000, 311000000, 'APERTURA CAJA', 'book', '/SistemaOptica/web/index.php?r=ventas/index-cajas&id=[id]&t=[t]'),
(310000000, 312000000, 'CIERRE CAJA', 'book', '/SistemaOptica/web/index.php?r=ventas/index-cierre-caja&id=[id]&t=[t]'),
(320000000, 321000000, 'VENTA DE LENTES', 'wpforms', '/SistemaOptica/web/index.php?r=ventas/index-venta&id=[id]&t=[t]'),
(320000000, 322000000, 'CONSULTA DE SALDOS', 'credit-card', '/SistemaOptica/web/index.php?r=ventas/index-saldo&id=[id]&t=[t]'),
(320000000, 323000000, 'REPORTE DE VENTA', 'file', '/SistemaOptica/web/index.php?r=ventas/index-informe-venta&id=[id]&t=[t]'),
(330000000, 331000000, 'COMPRA DE INSUMOS', 'cart-arrow-down', '/SistemaOptica/web/index.php?r=compras/index-compra&id=[id]&t=[t]'),
(330000000, 332000000, 'DONACIONES', 'cart-plus', '/SistemaOptica/web/index.php?r=compras/index-donaciones&id=[id]&t=[t]'),
(400000000, 410000000, 'AGENDAR OPERATIVO', 'user-md', '/SistemaOptica/web/index.php?r=operativos/index-agrega-operativo&id=[id]&t=[t]'),
(400000000, 420000000, 'OPERATIVOS', 'hospital-o', '/SistemaOptica/web/index.php?r=operativos/index-operativo&id=[id]&t=[t]'),
(400000000, 430000000, 'REPORTE OPERATIVO', 'file', '/SistemaOptica/web/index.php?r=operativos/index-informe-operativo&id=[id]&t=[t]'),
(400000000, 440000000, 'RECETAS', 'file-text-o', '/SistemaOptica/web/index.php?r=operativos/index-receta&id=[id]&t=[t]'),
(500000000, 510000000, 'USUARIOS', 'user-circle-o', '/SistemaOptica/web/index.php?r=mantencion/index-usuario&id=[id]&t=[t]'),
(500000000, 520000000, 'PRODUCTOS', 'dropbox', '/SistemaOptica/web/index.php?r=mantencion/index-producto&id=[id]&t=[t]'),
(500000000, 530000000, 'PRODUCTOS X PROVEE.', 'dropbox', '/SistemaOptica/web/index.php?r=mantencion/index-producto-proveedor&id=[id]&t=[t]'),
(500000000, 540000000, 'PROVEEDOR', 'user-o', '/SistemaOptica/web/index.php?r=mantencion/index-proveedor&id=[id]&t=[t]'),
(500000000, 550000000, 'PERSONAS', 'user-o ', '/SistemaOptica/web/index.php?r=mantencion/index-persona&id=[id]&t=[t]'),
(500000000, 560000000, 'CÓDIGOS GENERALES', 'barcode', '/SistemaOptica/web/index.php?r=mantencion/index-cod-general&id=[id]&t=[t]'),
(600000000, 601000000, 'PRODUCTOS', 'file', '/SistemaOptica/web/index.php?r=compras/reporte-producto-index&id=[id]&t=[t]'),
(600000000, 602000000, 'PRODUCTOS X PROVEE.', 'file', '/SistemaOptica/web/index.php?r=compras/reporte-pro-prov-index&id=[id]&t=[t]'),
(700000000, 710000000, 'STOCK', 'list-ol', '/SistemaOptica/web/index.php?r=inventario/index-inventario&id=[id]&t=[t]'),
(800000000, 810000000, 'CÓDIGOS WEB', 'barcode', '/SistemaOptica/web/index.php?r=sitioweb/index-codigos&id=[id]&t=[t]'),
(800000000, 820000000, 'PRODUCTOS WEB', 'dropbox', '/SistemaOptica/web/index.php?r=sitioweb/index-productos&id=[id]&t=[t]'),
(800000000, 830000000, 'EDICIÓN IMAGEN', 'file-image-o ', '/SistemaOptica/web/index.php?r=site/editar-imagen\r\n');
